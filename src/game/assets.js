export const ASSET_PATHS = {
  ...
  ui: {
    ...
    shovelSlot: ["assets/图片/植物大战僵尸素材包第二版/小部分组件/菜单栏/铲子槽.png", "assets/图片/道具/铲子槽.png"],
    shop: ["assets/图片/植物大战僵尸素材包第二版/小部分组件/菜单栏/植物商店.png", "assets/植物大战僵尸素材包第二版/小部分组件/菜单栏/植物商店.png"],
    seedChooser: ["assets/图片/更多……/SeedChooser_Background.png"],
    sunCounter: ["assets/图片/植物大战僵尸素材包第二版/小部分组件/阳关计数.png", "assets/图片/道具/阳关计数.png"],
    flagMeterEmpty: ["assets/图片/更多……/FlagMeterEmpty.png", "assets/图片/植物大战僵尸素材包第二版/小部分组件/进度/FlagMeterEmpty.png"],
    flagMeterFull: ["assets/图片/更多……/FlagMeterFull.png", "assets/图片/植物大战僵尸素材包第二版/小部分组件/进度/FlagMeterFull.png"],
