...
export const PLANTS = {
  ...
  repeater: { side: "plant", name: "双重射手", cost: 200, cooldown: 8, hp: 260, fireEvery: 1.55, damage: 22, projectile: "pea", burstCount: 2 },
  ...
  twinSunflower: { side: "plant", name: "双胞向日葵", cost: 150, cooldown: 9, hp: 220, produceEvery: 8.5, produceAmount: 50 },
